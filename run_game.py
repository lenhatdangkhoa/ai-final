...
def simulate_with_gui(Q_table, ql, cell_size, light_duration, max_steps):
    """
    Simulate the Q-learning agent in the environment with a GUI.
    Args:
        Q_table (dict): Q-table with learned values.
        ql (q_learning.Q_learning): Q-learning environment instance.
        cell_size (int): Size of each cell in the grid (change depends on screen size).
        light_duration (int): Duration for which the traffic light stays red or green.
    ...
    while running and step < max_steps:
        ...
        clock.tick(10)  #  Please adjust this if needed. Higher values will speed up the simulation.
